...
fullLength = document.addEventListener("scroll", () => {
  progressBar.style.width = calculateScrollPercentage();
});

function calculateScrollPercentage() {
  const fullLength = document.body.clientHeight - window.innerHeight;
  return Math.round(window.scrollY / (fullLength / 100)) + "%";
}
